...
exports.getIconFromExt = exports.getIconByName = exports.extensionsMap = exports.SvgIcon = void 0;
...
for (var cat in extensions_1["default"]) {
    if (extensions_1["default"].hasOwnProperty(cat)) {
        for (var _i = 0, _a = extensions_1["default"][cat]; _i < _a.length; _i++) {
            var ext = _a[_i];
            exports.extensionsMap[ext] = cat;
        }
    }
}
...
function getIconFromExt(ext) {
    ext = ext.toLowerCase();
    var cat = exports.extensionsMap[ext];
    return getIconByName(cat);
}
exports.getIconFromExt = getIconFromExt;
